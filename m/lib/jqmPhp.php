 ...
 * @var JQMPHP_JQ
 */
define('JQMPHP_JQ', 'https://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js', true);

/**
 * Sets the jQuery Mobile path.
 * @var JQMPHP_JQM
 */
define('JQMPHP_JQM', 'http://code.jquery.com/mobile/1.0.1/jquery.mobile-1.0.1.min.js', true);

/**
 * Sets the jQuery Mobile CSS path.
 * @var JQMPHP_CSS
 */
define('JQMPHP_CSS', 'http://code.jquery.com/mobile/1.0.1/jquery.mobile-1.0.1.min.css', true);
